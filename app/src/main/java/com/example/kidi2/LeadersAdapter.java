...
public class LeadersAdapter extends RecyclerView.Adapter<LeadersAdapter.ViewHolder> implements Filterable {
    Context context;
    private List<Leaders> leader_list;
    private List<Leaders> FullList;

    public LeadersAdapter(List<Leaders> leader_list) {
